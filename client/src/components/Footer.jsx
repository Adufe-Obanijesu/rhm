...
const Footer = () => {
    return (
        <footer className="py-16 px-10 lg:px-24 lg:py-16 bg-secondary relative">
                ...
                <div className="flex md:justify-center md:mb-0 mb-8">
                    <div className="inline">
                        ...
                        <ul className="lightgreyParagraph text-sm inline">
                            ...
                            <li className="footerLink"><Link to="/messages">Messages</Link></li>
                            <li className="footerLink"><Link to="/writeups">Write-ups</Link></li>
